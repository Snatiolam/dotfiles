...
-- fbeautiful.init(gears.filesystem.get_themes_dir() .. "default/theme.lua")

home = os.getenv("HOME")

beautiful.init(home .. "/.config/awesome/theme.lua")
-- beautiful.get().wallpaper = home .. "/Downloads/kace-rodriguez-p3OzJuT_Dks-unsplash.jpg"
...
awful.rules.rules = {
    ...
    { rule_any = {type = { "normal", "dialog" }
      }, properties = { titlebars_enabled = false } -- True if want title in each client
    },
